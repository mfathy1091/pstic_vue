...
<template>
    <div>  
        ...
        <FileIndividuals v-if="file" :file_id="file.id" />

        <FileReferrals v-if="file" :fileId="file.id" />
        <section class="experiences">
            <h2>Referrals</h2>
            <div class="card">
                <div class="card" v-for="referral in file.referrals" :key="referral.id">
...
import FileIndividuals from './FileIndividuals.vue'
import FileReferrals from './FileReferrals.vue'
