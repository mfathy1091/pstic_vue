...
export default {
	...
	methods: {
        ...
        getPswReferrals(){
			...
			axios.get('/api/referrals/currentMonth', { params: { is_new: this.filter.is_new, status_id: this.filter.status_id, month_id: this.filter.month.id, user_id: this.filter.user_id} })
			.then((response) => {
				// success
