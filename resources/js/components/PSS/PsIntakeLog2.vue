...
<template>
	<div class="p-0">
                    ...
                    <table v-show="psIntakes.length" class="border table table-hover table-sm">
                        ...
                        <tbody v-if="psIntakes">
                            <tr v-for="psIntake in this.psIntakes" :key="psIntake.id">
                                ...
                                <td>
                                    <span v-show="psIntake.status_id == '2'" class="badge badge-pill badge-secondary">Inactive</span>
                                    <span v-show="psIntake.status_id == '1'" class="badge badge-pill badge-success">Active</span>
                                    <span v-show="psIntake.status_id == '3'" class="badge badge-pill badge-dark">Closed</span>
                                    <span v-show="psIntake.status_id != '3'">
                                        <span v-show="psIntake.is_new == 1" class="badge badge-pill badge-info">New</span>
                                        <span v-show="psIntake.is_new == 0" class="badge badge-pill badge-warning">Ongoing</span>
                                    </span>
                                </td>
		...
		v-on:psIntakesChanged="getPsIntakes()">
		</PsIntakeModal>
