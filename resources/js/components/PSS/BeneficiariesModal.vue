<template>
    <div class="modal fade" id="psIntakeModal" tabindex="-1" aria-labelledby="psIntakeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 v-show="!psIntakeEditMode" class="modal-title" id="psIntakeModalLabel">Create New PS Intake</h5>
                    <h5 v-show="psIntakeEditMode" class="modal-title" id="psIntakeModalLabel">Edit PS Intake</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form @submit.prevent="psIntakeEditMode ? updatePsIntake() : createPsIntake()">
                    <div class="modal-body">
						<div class="form-group">
							<label class="typo__label">Choose Direct Beneficiaries</label>
							<div>
								<multiselect 
								v-model="psIntakeForm.direct_referral_beneficiaries" 
